...
<!-- CONVENÇÃO: Todo post que usar termos técnicos deve linkar para o glossário.
     Use a wikilink ou link relativo: [[notes/glossary|Glossário]] ou [Glossário](/notes/glossary)
     Adicione o link na primeira menção de cada termo técnico, ex:
     "O [Plexi](/notes/glossary#Plexi) é um amp valvulado..." -->
...
> Não sabe algum termo? Consulte o [Glossário](/notes/glossary).
